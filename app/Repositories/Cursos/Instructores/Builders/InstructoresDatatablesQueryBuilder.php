...
namespace App\Repositories\Cursos\Instructores\Builders;
...
class InstructoresDatatablesQueryBuilder
{
    private Instructores $model;
    private Request $request;
    private Builder $query;

    public function __construct(Instructores $model, Request $request)
    {
        $this->model = $model;
