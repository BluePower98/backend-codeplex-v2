...
namespace App\Repositories\Cursos\Grupos\Builders;
...
class GruposDatatablesQueryBuilder
{
    private Grupos $model;
    private Request $request;
    private Builder $query;

    public function __construct(Grupos $model, Request $request)
    {
        $this->model = $model;
